...
const algorithms = {
    "SubstitutionSimple": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1mIx3Ikx5GDnXVFlJp2-fNRq2CHO9Difz"
    },
    "Cesar": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=12F5D4TxRS16AX_0Cispr7EgRSzEvn3ze"
    },
    "Albam": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1eGCHVxFinPvKmHeOdpMHZFxkQQucPFIz"
    },
    "Atbash": {
    ...
    Download: "https://drive.google.com/uc?export=download&id=17uaTrJa9U0IZXqfbiJ0r_aHrth7tcL29"
  },
    ...
    "Atbah": {
      ...
      Chiffrement: "C(M) = 25 - M",
      Dechiffrement: "D(C) = 25 - C",
      Download: "https://drive.google.com/uc?export=download&id=1d05e1X1BCMAqJGJfjUC61jhcHs_BmFaO"
    },
    "Alberti": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1o89sVNhi5nZ3qhf2ZdOTOfNcRCDgYI_f"
    },
    "Polybe": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=16BdAKWU1TDV0wugMjDeC7asNn3t7r2uK"
    },
    "Trithemius": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=13PMjjthK9NpblJRWVmaRTwvC3KE8xSWB"
    },
    "Vigenere": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=15XZD90D7PlI-uul-UY_-b4sC3cpX4At2"
    },
    "Autokey": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1knXC6V5_bW3U2w5WEjNbKf2YyX4eLkTE"
    },
    "Porta": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1sm5lRo5FBSUyhspcUaSTGXo4yOa2kqDp"
    },
    "Beaufort": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1hS-ZOsFtWqOh8Ueg2fYoOaAWZkq8kr0g"
    },
    "Vernam(otp)": {
      ...
      Chiffrement: "C = M ⊕ K",
      Dechiffrement: "M = C ⊕ K",
      Download: "https://drive.google.com/uc?export=download&id=18wvI7YixUly5sQPn7WrDwYv4VA_rPxo3"
    },
      "DES": {
      ...
      Download: "https://drive.google.com/uc?export=download&id=1_zZsd7KH2PgmeqA9w_3pLT5Sy3CKgU6L"
    },
...
export default function AlgorithmPage() {
  ...
  className="inline-flex items-center px-6 py-3 bg-black/85 text-white font-semibold rounded-lg shadow-md hover:bg-black/75 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
>
  <svg
